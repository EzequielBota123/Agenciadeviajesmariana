...
export const AIRPORTS: Airport[] = [
  ...
  { iata: 'NQN', city: 'Neuquén', country: 'Argentina', aliases: ['neuquen', 'neuquén'] },
  { iata: 'CPC', city: 'San Martín de los Andes', country: 'Argentina', aliases: ['chapelco', 'san martin de los andes', 'san martín de los andes'] },
  { iata: 'CRD', city: 'Comodoro Rivadavia', country: 'Argentina', aliases: ['comodoro rivadavia', 'comodoro'] },
  { iata: 'REL', city: 'Trelew', country: 'Argentina', aliases: ['trelew', 'puerto madryn', 'peninsula valdes', 'península valdés'] },
  { iata: 'RGL', city: 'Río Gallegos', country: 'Argentina', aliases: ['rio gallegos', 'río gallegos'] },
  { iata: 'RGA', city: 'Río Grande', country: 'Argentina', aliases: ['rio grande', 'río grande', 'tierra del fuego'] },
  { iata: 'VDM', city: 'Viedma', country: 'Argentina', aliases: ['viedma'] },
  { iata: 'RSA', city: 'Santa Rosa', country: 'Argentina', aliases: ['santa rosa', 'la pampa'] },
  { iata: 'BHI', city: 'Bahía Blanca', country: 'Argentina', aliases: ['bahia blanca', 'bahía blanca'] },
  { iata: 'SFN', city: 'Santa Fe', country: 'Argentina', aliases: ['santa fe'] },
  { iata: 'TUC', city: 'Tucumán', country: 'Argentina', aliases: ['tucuman', 'tucumán', 'san miguel de tucuman'] },
  { iata: 'SDE', city: 'Santiago del Estero', country: 'Argentina', aliases: ['santiago del estero'] },
  { iata: 'CTC', city: 'Catamarca', country: 'Argentina', aliases: ['catamarca'] },
  { iata: 'IRJ', city: 'La Rioja', country: 'Argentina', aliases: ['la rioja'] },
  { iata: 'UAQ', city: 'San Juan', country: 'Argentina', aliases: ['san juan'] },
  { iata: 'LUQ', city: 'San Luis', country: 'Argentina', aliases: ['san luis'] },
  { iata: 'JUJ', city: 'Jujuy', country: 'Argentina', aliases: ['jujuy', 'san salvador de jujuy'] },
  { iata: 'CNQ', city: 'Corrientes', country: 'Argentina', aliases: ['corrientes'] },
  { iata: 'RES', city: 'Resistencia', country: 'Argentina', aliases: ['resistencia', 'chaco'] },
  { iata: 'FMA', city: 'Formosa', country: 'Argentina', aliases: ['formosa'] },
  { iata: 'PSS', city: 'Posadas', country: 'Argentina', aliases: ['posadas', 'misiones'] },
  ...
  { iata: 'REC', city: 'Recife', country: 'Brasil', aliases: ['recife'] },
  { iata: 'NAT', city: 'Natal', country: 'Brasil', aliases: ['natal'] },
  ...
  { iata: 'ASU', city: 'Asunción', country: 'Paraguay', aliases: ['asuncion', 'asunción', 'paraguay'] },
